...
from modules.foundation.web.deps import access_token_security
from modules.foundation.web.forms import (
    RegisterForm,
    LoginForm,
    ForgotPasswordForm,
    ResetPasswordForm,
)
from modules.foundation.web.templates import templates, template
