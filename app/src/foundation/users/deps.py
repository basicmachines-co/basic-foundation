...
def get_user_repository(async_session: AsyncSession = Depends(get_async_session)) -> Repository[User]:  # pragma: no cover 
...
def get_user_pagination(repository: UserRepositoryDep) -> UserPagination:       # pragma: no cover
